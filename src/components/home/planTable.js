            ...
            return (
                <tr key={plan.id}>
                    ...
                    <td className="pr-6">
                        ...
                        <div id={`plans-options-dropdown-${plan.id}`} type="button" className="hidden mx-3 mr-10 origin-top-right absolute right-7 top-0 w-48 mt-1 rounded-md shadow-lg z-10 bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200" role="menu" aria-orientation="vertical" aria-labelledby="project-options-menu-0">
                            <div className="py-1" role="none">
                            <button id={`plans-edit-${plan.id}`} className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                            <AiOutlineEdit className="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" />
                                Edit
                            </button>
                            <button id={`plans-delete-${plan.id}`} type="button" className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem" onClick={() => deletePlan(plan.id)}>
