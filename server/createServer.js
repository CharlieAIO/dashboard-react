const create = (id) => {
    ...
    require('dotenv').config({path: path.resolve(__dirname, `../${id}.env`) });
    ...
    app.listen(process.env.PORT_SERVER, () => console.log(`New server running on port:${process.env.PORT_SERVER}`))
